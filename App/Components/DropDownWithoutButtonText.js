        ...
        return (
            <TouchableOpacity activeOpacity={.9} style={[Styles.perantDropDown, { width: this.props.Width,alignItems: 'center' }]} onPress={() => {
                ...
                <ModalDropdown
                    ...
                    renderRow={(item, index, IsSelected) => {
                        ...
                        return (<View style={{ width: '100%', height: Height * .06, backgroundColor: '#FAFAFA', paddingHorizontal: Width * .04, justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center' }}>
                            <Image resizeMode='contain' style={{ width: Width * .04, height: Height * .04 }} source={item.Icon}  >
                            </Image>
                ...
                this.refs.dropdown1.show()
                            ...
                            <Image resizeMode={'contain'} source={Requires.dots} style={{ width: Width * .06, height: '100%',tintColor:Colors.DarkGrayColor }} />
                </TouchableOpacity>
            </TouchableOpacity>
        )
    }
...
const Styles = StyleSheet.create({
    DropDown: {
        width: "100%", justifyContent: 'center', height: Height * .07
    },
    ...
    textStyle: {
        color: Colors.WhiteColor, width: Width * .8, fontSize: Width * 0.038, textAlign: 'right', textAlign: 'left', paddingHorizontal: Width * .03, fontFamily: FontFamilies.Etisalat_0
    },
    dropdownStyle: {

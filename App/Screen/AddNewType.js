...
const addNewTypeAction = AppReducer.addNewTypeAction;
    ...
    render() {
        ...
        return (<View style={{
            ...
            <TouchableOpacity onPress={async () => {
                if(this.state.NamePlan==""||this.state.CurantSelected==-1){
                    return 
                }
                this.props.navigation.goBack()
                let Icon=Requires.ICons[this.state.CurantSelected].icon
                let text=this.state.NamePlan

                this.props.addNewTypeAction(this.props.navigation.state.params.index, Icon, text)
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        addNewTypeAction:  (index, icon, text) => dispatch(addNewTypeAction (index, icon, text)),

    ...
    render() {
        ...
        return (<View style={{
            ...
            {/* //header */}
                ...
                <View style={{ width:'95%', height: Height * .15, justifyContent: 'center',alignItems:'center' }}>
                        <Text style={[Styles.FirstCategoryHeader,{fontFamily:FontFamilies.Etisalat_0,fontSize:20,color:'#000'}]}>{strings('plans')}</Text>
                        <Text style={[Styles.FirstCategoryHeader,{marginTop:Height*.01,fontFamily:FontFamilies.Etisalat_0,fontSize:15,width:'100%',textAlign:'center'}]}>{strings('titlePlan')}</Text>
        ...
        category: 'Drink' } */}
                        {IsLoding && this.props.goals.length >= 1 &&this.props.goals.map((item, index) => {
                            ...
                            {IsLoding && this.props.goals.length < 1 && <View style={{ width:Width,height:Height*.65,alignItems:'center',justifyContent:'center'}}>
                      <Image resizeMode='contain' style={{ width: Width * .3, height: Width * .3 }} source={Requires.goalIcon} />
                      <Text style={[{ fontFamily: FontFamilies.Etisalat_0, fontSize: 18, color: Colors.DarkGrayColor ,marginTop:Height*.03}]}>{strings('noGols')}</Text>
